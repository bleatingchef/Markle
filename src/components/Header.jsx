    ...
    <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${openNavigation ? "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"}`}>
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <Link className="block w-[12rem] xl:mr-8" to="/">
          <img src={i1} width={190} height={40} alt="Brainwave" />
        </Link>
        ...
        <a href="#" className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:flex items-center">
          <div className="flex justify-center">
            <img src={l1} width={30} height={30} alt="Logo 1" className="mx-2" />
            <img src={l2} width={30} height={30} alt="Logo 2" className="mx-2" />
            <img src={l3} width={30} height={30} alt="Logo 3" className="mx-2" />
            <img src={l4} width={30} height={30} alt="Logo 4" className="mx-2" />
          </div>
        </a>
